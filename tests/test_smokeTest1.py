...
class TestSmokeTest1():
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("Ntombi")
  ...
  def test_homePage(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(834, 727)
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Ntombi")
    self.driver.find_element(By.NAME, "lname").send_keys("Hontyo")
    self.driver.find_element(By.NAME, "bizname").send_keys("NtombiSoftware")
